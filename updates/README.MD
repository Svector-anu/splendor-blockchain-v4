...
### Basic Update
\`\`\`bash
cd /root/ && curl -fsSL -o update.sh https://raw.githubusercontent.com/Splendor-Protocol/splendor-blockchain-v4/main/updates/update.sh && chmod +x update.sh && ./update.sh
\`\`\`
